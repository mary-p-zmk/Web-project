document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadData() {
        try {
            ...
            itemsContainer.innerHTML = '<p class="text-center">Не вдалося завантажити меню.</p>';
        }
    }
    ...
    function renderRecipeGrid(recipes) {
        ...
        if (recipes.length === 0) {
            recipeGrid.innerHTML = '<div class="col-12 text-center py-5"><p>Рецептів не знайдено...</p></div>';
            return;
        }
    ...
    function filterRecipes() {
        ...
        const filtered = allRecipes.filter(r => {
            ...
            const matchesCountry = countryTerm === 'all' || r.countryId === countryTerm;
